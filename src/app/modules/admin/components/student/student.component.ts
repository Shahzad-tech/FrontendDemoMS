...
export class StudentComponent implements OnInit {
  ...
  constructor(private _authService:AuthService, private modalService: NgbModal, private _dataService: DataService, private router: Router, private _alertService :SwalService) { }
  ...
  StudentRegistrationForm = new FormGroup({
    ...
    UniRollNo: new FormControl('', [Validators.required, Validators.pattern('^[A-Z0-9-]+$')]),
    ...
    CurrentGPA: new FormControl('',[Validators.required , Validators.pattern('^[0-9.]*$'), Validators.min(1),Validators.max(4)]),
  ...
  this.router.navigate(["admin/UpdateStudent"], {queryParams:{data:JSON.stringify(val)}})
  }
  getPrograms(){
